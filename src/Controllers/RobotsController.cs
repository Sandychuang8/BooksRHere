...
namespace BooksRHere.Controllers
{
    public class RobotsController : Controller
    {
        ...
        public void RsdXml()
        {
            ...
            xml.WriteElementString("enginename", "BooksRHere");
            xml.WriteElementString("enginelink", "http://github.com/Sandychuang8/BooksRHere/");
        ...
        private async Task<ISyndicationFeedWriter> GetWriter(string? type, XmlWriter xmlWriter, DateTime updated)
        {
            ...
            if (type?.Equals("rss", StringComparison.OrdinalIgnoreCase) ?? false)
            {
                ...
                await rss.WriteGenerator("BooksRHere").ConfigureAwait(false);
            ...
            await atom.WriteGenerator("BooksRHere", "https://github.com/Sandychuang8/BooksRHere", "1.0").ConfigureAwait(false);
